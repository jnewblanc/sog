    ...
    def testRoomVsTarget(self):
        ...
        for num in range(1, 4):
            obj = self.createObject(
                num=99990 + num, type="Portal", name="portal" + str(num)
            )
        ...
        logger.debug("inv: " + str([str(x) + " " + x.describe() for x in iList]))
        ...
        logger.debug("tList: " + str([str(x) + " " + x.describe() for x in tList]))
